...
class DonorRegistration(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'phone_number' : forms.TextInput(attrs={'class':'form-control', 'required':'True', 'default':'+880'}),
            'email' : forms.EmailInput(attrs={'class':'form-control', 'required':'True'}),
            'occupation' : forms.TextInput(attrs={'class':'form-control', 'required':'True'}),
            'student_id': forms.TextInput(attrs={'class':'form-control', 'required':'True', 'placeholder':'Cse - id'}),
